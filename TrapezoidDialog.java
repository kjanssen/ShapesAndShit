...
public class TrapezoidDialog extends JDialog implements ActionListener 
{
	...
	public TrapezoidDialog(JFrame frame, boolean modal, int x, int y, int S1, int S2, int S3, double A, Color C)
	{
 		super(frame, modal);
		oldSide = S1;
		side = oldSide;
