// file: ShapeSelectionDialog.java
...
public class ShapeSelectionDialog extends JDialog implements ActionListener 
{
    ...
    public ShapeSelectionDialog(JFrame frame, boolean modal, int x, int y)
        //public ShapeSelectionDialog(JPanel frame, boolean modal, int x, int y)
    {
        super(frame, modal);
        myPanel = new JPanel();
